...
export const loginUser = (req, res) => {
    ...
    try {
        pool.query('SELECT * FROM users WHERE email = $1', [req.query.email], (error, results) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Сравниваем пароли
            const isValidPass = yield bcrypt.compare(String(req.query.password), user.password);
            if (!isValidPass) {
                return res.json({
                    access: false,
                    message: 'Неверный логин или пароль',
...
export const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        pool.query('INSERT INTO users (id, name, fname, password, email, icon_url) VALUES ($1, $2, $3, $4, $5, $6)', [userId, req.body.name, req.body.fname, passwordHash, req.body.email, req.body.imgUrl], (error, results) => {
            if (error)
                throw error;
            res.status(201).json({
                token: generateJWT({
